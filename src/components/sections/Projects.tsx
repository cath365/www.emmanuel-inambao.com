...
export default function Projects() {
  ...
  return (
    <section id="projects" className="bg-brand-camel py-16 text-brand-navy sm:py-20 lg:py-24" aria-labelledby="projects-heading">
      <div className="section-container">
        <div className="border-t border-brand-navy/15 pt-10">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-brand-chocolate/70">Selected work</p>
            <h2 id="projects-heading" className="mt-3 font-serif text-4xl font-semibold tracking-[-0.025em] sm:text-5xl">
              Projects
            </h2>
            <p className="mt-4 max-w-2xl text-base leading-8 text-brand-navy/65">
