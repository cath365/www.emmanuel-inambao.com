...
export default function ProjectFilter({ filters, activeFilter, onChange }: ProjectFilterProps) {
  return (
    <div className="-mx-4 overflow-x-auto border-b border-brand-navy/15 px-4 sm:mx-0 sm:px-0" aria-label="Filter selected projects">
          ...
          return (
            <button
              ...
              className={
                ...
                (active
                  ? 'border-brand-chocolate text-brand-navy'
                  : 'border-transparent text-brand-navy/55 hover:text-brand-chocolate')
              }
            >
              {filter}
            </button>
