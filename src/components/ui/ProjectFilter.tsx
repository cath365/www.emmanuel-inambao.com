...
export default function ProjectFilter({ filters, activeFilter, onChange }: ProjectFilterProps) {
  return (
    <div className="-mx-4 overflow-x-auto border-b border-brand-cream/10 px-4 sm:mx-0 sm:px-0" aria-label="Filter selected projects">
          ...
          return (
            <button
              ...
              className={
                ...
                (active
                  ? 'border-brand-sky text-brand-cream'
                  : 'border-transparent text-brand-cream/45 hover:text-brand-cream')
              }
            >
              {filter}
            </button>
